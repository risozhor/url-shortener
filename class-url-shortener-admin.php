	...
	function get_settings_fields() {
		...
		$settings_fields = array(
            'urlshortener_defaults' => array(
                ...
                array(
                    'name'    => 'delete_data',
                    'label'   => __( 'Delete Data', 'first-url-shortener-pro' ),
                    'desc'    => __( 'Should all plugin data be deleted upon uninstalling this plugin?', 'first-url-shortener-pro' ),
                    'type'    => 'select',
                    'default' => 'no',
                    'options' => array(
                        'yes'       => __('Yes', 'first-url-shortener'),
                        'no'        => __('No', 'first-url-shortener')
                    )
                ),
            ),
