...
function isBrowserAgent($agent=""){
	...
	if($this->isSpammer($ua)!==false){
		if(function_exists('__'))$browser['name']=__( "Script Injection Bot", 'first-url-shortener' );
...
function isSpiderAgent($agent=""){
	...
	if(empty($ua))return false;  //nothing to check
	$unknown_spider=(function_exists("__"))?__( "Unknown Spider", 'first-url-shortener' ):"Unknown Spider";
	$unknown_feedreader=(function_exists("__"))?__( "Unknown Feedreader", 'first-url-shortener' ):"Unknown Feedreader";
	//##detect spiders
	...
	if($this->isSpammer($ua)!==false){
		$spider['name']=_e( "Script Injection Bot", 'first-url-shortener' );
		$spider['agenttype']="S";
	}
